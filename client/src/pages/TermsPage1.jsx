...
const sections = [
    ...
    content: (
      <>
        <p className="text-gray-700 leading-relaxed">
          By accessing or using <strong>Resume AI</strong> ("the Platform"), you confirm that you have read, understood, and agree to be bound by these Terms of Service and all applicable laws of India. These Terms constitute a legally binding agreement under the <strong>Indian Contract Act, 1872</strong>.
        </p>
    ...
    content: (
      <>
        <p className="text-gray-700 leading-relaxed mb-3">
          To use Resume AI, you must be at least <strong>18 years of age</strong> and capable of entering into a legally binding contract under Indian law. By registering, you agree to:
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-700 leading-relaxed mb-3">
          Resume AI provides AI-powered career tools including, but not limited to:
        </p>
      ...
      <>
        ...
        <ul className="space-y-2 text-gray-700">
          {[
            ...
            'Infringe upon any intellectual property rights of Resume AI or third parties',
  ...
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-700 leading-relaxed mb-3">
          Resume AI offers both free and paid subscription plans. All payments are processed in <strong>Indian Rupees (INR)</strong> via UPI (Unified Payments Interface). By making a payment, you agree to the following:
        </p>
    ...
    content: (
      <>
        <div className="space-y-3 text-gray-700">
          <p><strong>Our Content:</strong> All content, branding, features, and functionality of Resume AI are owned by us and protected under the <strong>Copyright Act, 1957</strong> and other applicable Indian intellectual property laws.</p>
    ...
    content: (
      <>
        ...
        <p className="text-gray-700 mt-3 leading-relaxed">
          Resume AI does not guarantee job placement, interview calls, or career outcomes as a result of using the Platform. Results depend on individual effort, market conditions, and third-party decisions.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="text-gray-700 leading-relaxed mb-3">
          To the maximum extent permitted under Indian law, Resume AI shall not be liable for any indirect, incidental, special, or consequential damages arising from:
        </p>
        <ul className="space-y-2 text-gray-700">
          {[
      ...
      <>
        ...
        <div className="border-3 border-black p-4 bg-neo-green/10">
          <div className="space-y-2 text-gray-800">
            <p><strong>Name:</strong> Grievance Officer, Resume AI</p>
  ...
  return (
    <>
      <SEO
        ...
        description="Resume AI Terms of Service - Read our terms and conditions governing the use of our AI resume analyzer platform."
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 p-5 border-3 border-black bg-neo-blue/10 shadow-[4px_4px_0px_#000]">
            <p className="text-gray-700 leading-relaxed">
              Please read these Terms of Service carefully before using Resume AI. These terms govern your use of our AI-powered resume enhancement platform and form a binding legal agreement between you and Resume AI under <strong>Indian law</strong>. Click on any section below to expand it.
            </p>
          </div>
      ...
      <footer className="bg-black text-white py-8 px-4 border-t-3 border-black">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-gray-400 text-sm">
          <p>© 2026 Resume AI. All rights reserved. | Governed by Laws of India</p>
